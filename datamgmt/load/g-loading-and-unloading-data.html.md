...
-  Load and register file data generated by an external system such as Hive or Spark into HAWQ internal tables.
-  Recover cluster data from a backup cluster for disaster recovery, using a YAML file.

HAWQ leverages the parallel architecture of the Hadoop Distributed File System (HDFS) to access files on that system.
