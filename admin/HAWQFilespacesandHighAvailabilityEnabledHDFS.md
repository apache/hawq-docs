...
### Step 2: Update HAWQ Configuration to Use NameNode HA <a id="namenodehacli"></a>
...
### Step 4: Stop the HAWQ Cluster and Back Up the Catalog <a id="stoppinghawqclusterandbackupcatalog"></a>
...
### Step 5: Move the Filespace Location <a id="movingthefilespacelocation"></a>
...
### Step 6: Configure $\{GPHOME\}/etc/hdfs-client.xml <a id="configuregphomeetchdfsclientxml"></a>

Configure the hdfs-client.xml file.

### Step 7: Restart the HAWQ Cluster and Resynchronize the Standby Master <a id="reinitializethestandbymaster"></a>
