...
## Allowing Connections to HAWQ <a name="topic2"></a>
...
### Editing the pg\_hba.conf File <a name="topic3"></a>
...
#### Editing pg\_hba.conf <a name="ip144328"></a>
...
## Limiting Concurrent Connections <a name="topic4"></a>
...
### To change the number of allowed connections <a name="ip142411"></a>
...
## Encrypting Client/Server Connections <a name="topic5"></a>
...
### Creating a Self-signed Certificate without a Passphrase for Testing Only <a name="topic6"></a>
